...
public class abaana extends Activity implements B4AActivity{
	public static abaana mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.LugandaHymnalNew", "com.LugandaHymnalNew.abaana");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (abaana).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.LugandaHymnalNew", "com.LugandaHymnalNew.abaana");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.LugandaHymnalNew.abaana", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (abaana) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (abaana) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (abaana) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (abaana) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
_in = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 50;BA.debugLine="in.Initialize(in.ACTION_SEND, \"\")";
_in.Initialize(_in.ACTION_SEND,"");
 //BA.debugLineNum = 51;BA.debugLine="in.PutExtra(\"android.intent.extra.TEXT\", sMes)";
_in.PutExtra("android.intent.extra.TEXT",(Object)(_smes));
 //BA.debugLineNum = 52;BA.debugLine="in.SetType(\"text/plain\")";
_in.SetType("text/plain");
 //BA.debugLineNum = 53;BA.debugLine="in.WrapAsIntentChooser(\"Share Via\")";
_in.WrapAsIntentChooser("Share Via");
 //BA.debugLineNum = 54;BA.debugLine="StartActivity(in)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_in.getObject()));
 //BA.debugLineNum = 55;BA.debugLine="End Sub";
return "";
}
public static String  _webview1_pagefinished(String _url) throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub WebView1_PageFinished (Url As String)";
