...
public class adv extends Activity implements B4AActivity{
	public static adv mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.LugandaHymnalNew", "com.LugandaHymnalNew.adv");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (adv).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.LugandaHymnalNew", "com.LugandaHymnalNew.adv");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.LugandaHymnalNew.adv", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (adv) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (adv) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (adv) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (adv) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public uk.co.martinpearman.b4a.webkit.DefaultJavascriptInterface _ji1 = null;
...
mostCurrent._ji1.Initialize(mostCurrent.activityBA);
...
mostCurrent._wve.AddJavascriptInterface((Object)(mostCurrent._ji1),"B4A");
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("GUMIKIRIZA"));
 //BA.debugLineNum = 32;BA.debugLine="WVE.LoadUrl(\"https://newlugandahymnal.onrender.co";
mostCurrent._wve.LoadUrl("https://newlugandahymnal.onrender.com/leson");
...
public static void  _call(String _command) throws Exception{
...
public ResumableSub_Call(com.LugandaHymnalNew.adv parent,String _command) {
this.parent = parent;
this._command = _command;
}
com.LugandaHymnalNew.adv parent;
String _command;
String _permission = "";
...
public static String  _columnsupdate(String _dbn,String _tn,String _setphrase,String _selectcol,String _selectvalue) throws Exception{
 //BA.debugLineNum = 79;BA.debugLine="Sub columnsUpdate(dbN As String, tN As String, set";
 //BA.debugLineNum = 80;BA.debugLine="Try";
try { //BA.debugLineNum = 81;BA.debugLine="sqlDb.multiColumnUpdate(dbN, tN, setPhrase, sele";
mostCurrent._sqldb._multicolumnupdate /*String*/ (mostCurrent.activityBA,_dbn,_tn,_setphrase,_selectcol,_selectvalue);
 } 
       catch (Exception e4) {
			processBA.setLastException(e4); //BA.debugLineNum = 83;BA.debugLine="codes.failure(LastException.Message)";
mostCurrent._codes._failure /*String*/ (mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 //BA.debugLineNum = 84;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("55570565",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 86;BA.debugLine="End Sub";
return "";
}
public static String  _columnupdate(String _dbn,String _tn,String _setcol,String _selectcol,String _selectvalue,String _newvalue) throws Exception{
 //BA.debugLineNum = 70;BA.debugLine="Sub columnUpdate(dbN As String, tN As String, setC";
 //BA.debugLineNum = 71;BA.debugLine="Try";
try { //BA.debugLineNum = 72;BA.debugLine="sqlDb.singleColumnUpdate(dbN, tN, setCol, select";
mostCurrent._sqldb._singlecolumnupdate /*String*/ (mostCurrent.activityBA,_dbn,_tn,_setcol,_selectcol,_selectvalue,_newvalue);
 } 
       catch (Exception e4) {
			processBA.setLastException(e4); //BA.debugLineNum = 74;BA.debugLine="codes.failure(LastException.Message)";
mostCurrent._codes._failure /*String*/ (mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 //BA.debugLineNum = 75;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("55505029",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 77;BA.debugLine="End Sub";
return "";
}
public static String  _createtable(String _dbn,String _tn,String _schema) throws Exception{
 //BA.debugLineNum = 88;BA.debugLine="Sub createTable(dbN As String, tN As String, schem";
 //BA.debugLineNum = 89;BA.debugLine="Try";
try { //BA.debugLineNum = 90;BA.debugLine="sqlDb.createTable(dbN, tN, schema)";
mostCurrent._sqldb._createtable /*String*/ (mostCurrent.activityBA,_dbn,_tn,_schema);
 } 
       catch (Exception e4) {
			processBA.setLastException(e4); //BA.debugLineNum = 92;BA.debugLine="codes.failure(LastException.Message)";
mostCurrent._codes._failure /*String*/ (mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 //BA.debugLineNum = 93;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("55636101",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
mostCurrent._ji1 = new uk.co.martinpearman.b4a.webkit.DefaultJavascriptInterface();
 //BA.debugLineNum = 20;BA.debugLine="End Sub";
return "";
}
public static String  _open_web(String _link) throws Exception{
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 60;BA.debugLine="Sub Open_web(Link As String)";
 //BA.debugLineNum = 61;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 62;BA.debugLine="StartActivity(p.OpenBrowser(Link))";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_p.OpenBrowser(_link)));
 //BA.debugLineNum = 63;BA.debugLine="Log(\"true\")";
anywheresoftware.b4a.keywords.Common.LogImpl("55373955","true",0);
...
public static String  _senderror(String _sj,String _ms) throws Exception{
 //BA.debugLineNum = 66;BA.debugLine="Sub SendError(Sj As String, Ms As String)";
 //BA.debugLineNum = 67;BA.debugLine="codes.SendEmail(Sj,Ms)";
mostCurrent._codes._sendemail /*String*/ (mostCurrent.activityBA,_sj,_ms);
