...
public class emisi extends Activity implements B4AActivity{
	public static emisi mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.LugandaHymnalNew", "com.LugandaHymnalNew.emisi");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (emisi).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.LugandaHymnalNew", "com.LugandaHymnalNew.emisi");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.LugandaHymnalNew.emisi", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (emisi) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (emisi) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (emisi) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (emisi) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _webviewclient_pagefinished(String _url) throws Exception{
 //BA.debugLineNum = 37;BA.debugLine="Sub WebViewClient_PageFinished (Url As String)";
...
public static String  _webviewclient_receivederror(int _errorcode,String _description,String _failingurl) throws Exception{
 //BA.debugLineNum = 31;BA.debugLine="Sub WebViewClient_ReceivedError(ErrorCode As Int,";
 //BA.debugLineNum = 32;BA.debugLine="WVE.LoadHtml(customwebviewerror.GetErrorPageHtml(";
...
public static String  _webviewclient_receivedsslerror(uk.co.martinpearman.b4a.webkit.SslErrorHandler _sslerrorhandler1,uk.co.martinpearman.b4a.net.http.SslError _sslerror1) throws Exception{
 //BA.debugLineNum = 34;BA.debugLine="Sub WebViewClient_ReceivedSslError(SslErrorHandler";
 //BA.debugLineNum = 35;BA.debugLine="SslErrorHandler1.Cancel";
