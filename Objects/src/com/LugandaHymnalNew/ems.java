...
public class ems extends Activity implements B4AActivity{
	public static ems mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.LugandaHymnalNew", "com.LugandaHymnalNew.ems");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (ems).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.LugandaHymnalNew", "com.LugandaHymnalNew.ems");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.LugandaHymnalNew.ems", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (ems) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (ems) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (ems) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (ems) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
mostCurrent._wve.LoadUrl("https://newlugandahymnal.onrender.com/emisi");
...
public ResumableSub_Call(com.LugandaHymnalNew.ems parent,String _command) {
this.parent = parent;
this._command = _command;
}
com.LugandaHymnalNew.ems parent;
String _command;
String _permission = "";
...
anywheresoftware.b4a.keywords.Common.LogImpl("510878979","true",0);
