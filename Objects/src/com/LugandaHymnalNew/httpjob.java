...
public class httpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.LugandaHymnalNew.httpjob");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.LugandaHymnalNew.httpjob.class).invoke(this, new Object[] {null});
        else
...
public String _vvvvvvvvv3 = "";
public String _vvvvvvvvv4 = "";
public String _vvvvvvvvv5 = "";
public Object _vvvvvvvvv6 = null;
public String _vvvvvvvvv7 = "";
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest _vvvvvvvvv0 = null;
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse _vvvvvvvvvv1 = null;
public Object _vvvvvvvvvv2 = null;
...
public String  _vvvvvv1(String _link) throws Exception{
...
if ((_vvvvvvvvvv4).equals("") || _link.contains(":")) { 
if (true) return _link;};
 //BA.debugLineNum = 45;BA.debugLine="Return DefaultScheme & \"://\" & Link";
if (true) return _vvvvvvvvvv4+"://"+_link;
...
_vvvvvvvvvv3 = "https://invalid-url/";
...
_vvvvvvvvv7 = BA.NumberToString(_id);
 //BA.debugLineNum = 308;BA.debugLine="CallSubDelayed2(target, \"JobDone\", Me)";
__c.CallSubDelayed2(ba,_vvvvvvvvv6,"JobDone",this);
 //BA.debugLineNum = 309;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvv2(String _link) throws Exception{
...
_vvvvvvvvv0.InitializeDelete(_vvvvvvvvvv3);
 };
 //BA.debugLineNum = 260;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvv0.getObject()),"SubmitJob",this);
 //BA.debugLineNum = 261;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvv3(String _link,String[] _parameters) throws Exception{
...
_vvvvvvvvv0.InitializeDelete(_vvvvvv6(_link,_parameters));
 } 
       catch (Exception e5) {
...
_vvvvvvvvv0.InitializeDelete(_vvvvvv6(_vvvvvvvvvv3,_parameters));
 };
...
_vvvvvvvvv0.InitializeGet(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvvv0.InitializeGet(_vvvvvvvvvv3);
 };
...
public String  _vvvvvv5(String _link,String[] _parameters) throws Exception{
...
_vvvvvvvvv0.InitializeGet(_vvvvvv6(_link,_parameters));
 } 
       catch (Exception e5) {
...
_vvvvvvvvv0.InitializeGet(_vvvvvv6(_vvvvvvvvvv3,_parameters));
 };
...
public String  _vvvvvv6(String _link,String[] _parameters) throws Exception{
...
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvv7() throws Exception{
...
_b = __c.LoadBitmap(_vvvvv0._vvvv5 /*String*/ ,_vvvvvvvvv7);
 //BA.debugLineNum = 324;BA.debugLine="Return b";
if (true) return _b;
 //BA.debugLineNum = 325;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvv0(int _width,int _height,boolean _keepaspectratio) throws Exception{
...
if (true) return __c.LoadBitmapResize(_vvvvv0._vvvv5 /*String*/ ,_vvvvvvvvv7,_width,_height,_keepaspectratio);
 //BA.debugLineNum = 334;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvvv1(int _width,int _height) throws Exception{
...
if (true) return __c.LoadBitmapSample(_vvvvv0._vvvv5 /*String*/ ,_vvvvvvvvv7,_width,_height);
 //BA.debugLineNum = 330;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.streams.File.InputStreamWrapper  _vvvvvvv2() throws Exception{
...
_in = __c.File.OpenInput(_vvvvv0._vvvv5 /*String*/ ,_vvvvvvvvv7);
 //BA.debugLineNum = 341;BA.debugLine="Return In";
if (true) return _in;
 //BA.debugLineNum = 342;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest  _vvvvvvv3() throws Exception{
 //BA.debugLineNum = 301;BA.debugLine="Public Sub GetRequest As OkHttpRequest";
 //BA.debugLineNum = 302;BA.debugLine="Return req";
if (true) return _vvvvvvvvv0;
...
if (true) return _vvvvvvv5("UTF8");
 //BA.debugLineNum = 284;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvv5(String _encoding) throws Exception{
...
_tr.Initialize2((java.io.InputStream)(__c.File.OpenInput(_vvvvv0._vvvv5 /*String*/ ,_vvvvvvvvv7).getObject()),_encoding);
...
public String  _vvvvvvv6(String _link) throws Exception{
...
_vvvvvvvvv0.InitializeHead(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvvv0.InitializeHead(_vvvvvvvvvv3);
 };
...
_vvvvvvvvv6 = _targetmodule;
 //BA.debugLineNum = 41;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvvv7(anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _stream,boolean _empty) throws Exception{
...
public String  _vvvvvvv0(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvv0.InitializePatch2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvvv0.InitializePatch2(_vvvvvvvvvv3,_data);
 };
...
public String  _vvvvvvvv1(String _link,String _text) throws Exception{
...
_vvvvvvv0(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 85;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvv2(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvv0.InitializePost2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvvv0.InitializePost2(_vvvvvvvvvv3,_data);
 };
...
public String  _vvvvvvvv3(String _link,String _dir,String _filename) throws Exception{
int _length = 0;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_vvvvvvvv2(_link,_out.ToBytesArray());
 }else {
 //BA.debugLineNum = 203;BA.debugLine="req.InitializePost(Link, In, length)";
_vvvvvvvvv0.InitializePost(_link,(java.io.InputStream)(_in.getObject()),_length);
...
public String  _vvvvvvvv4(String _link,anywheresoftware.b4a.objects.collections.Map _namevalues,anywheresoftware.b4a.objects.collections.List _files) throws Exception{
String _boundary = "";
...
String _value = "";
String _s = "";
com.LugandaHymnalNew.httpjob._multipartfiledata _fd = null;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_empty = _vvvvvvv7(_stream,_empty);
...
_fd = (com.LugandaHymnalNew.httpjob._multipartfiledata)(group17.Get(index17));
...
_vvvvvvvv2(_link,_stream.ToBytesArray());
 //BA.debugLineNum = 166;BA.debugLine="req.SetContentType(\"multipart/form-data; boundary";
_vvvvvvvvv0.SetContentType("multipart/form-data; boundary="+_boundary);
 //BA.debugLineNum = 167;BA.debugLine="req.SetContentEncoding(\"UTF8\")";
_vvvvvvvvv0.SetContentEncoding("UTF8");
 //BA.debugLineNum = 168;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvv5(String _link,String _text) throws Exception{
...
_vvvvvvvv2(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 51;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvv6(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvv0.InitializePut2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvvv0.InitializePut2(_vvvvvvvvvv3,_data);
 };
...
public String  _vvvvvvvv7(String _link,String _text) throws Exception{
...
_vvvvvvvv6(_link,_text.getBytes("UTF8"));
...
__c.File.Delete(_vvvvv0._vvvv5 /*String*/ ,_vvvvvvvvv7);
